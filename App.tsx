...
const App: React.FC = () => {
  ...
  return (
    <div className="min-h-screen bg-slate-900 text-gray-100 flex flex-col items-center p-4 sm:p-6 md:p-8 font-sans">
      <div className="w-full max-w-6xl mx-auto">
        <Header />
        <p className="mt-4 text-center text-lg text-gray-400 max-w-3xl mx-auto">
        ...
        <main className="mt-12 w-full grid md:grid-cols-2 md:gap-12 items-start">
          <div className="flex flex-col gap-8 bg-slate-800/50 p-8 rounded-xl border border-gray-700">
            <InputForm
              name={name}
              setName={setName}
          ...
          <div className="mt-8 md:mt-0 flex flex-col items-center justify-center min-h-[400px] bg-slate-800/50 p-8 rounded-xl border border-gray-700">
